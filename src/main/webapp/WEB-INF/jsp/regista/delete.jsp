...
<body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<div class='card'>
				<div class='card-header'>Elimina dettaglio</div>
				...
				<div align="left" >
					...
					<div align="right">
					<form 
						action="${pageContext.request.contextPath}/regista/listafilm/${delete_regista_attr.id}">
						<input type="hidden" value="${delete_regista_attr.id}"
							name="idRegista" id="idRegista">
						<button type="submit" name="submit" id="submit"
							class="btn btn-primary">Vedi lista film</button>
					</form>
				</div>
