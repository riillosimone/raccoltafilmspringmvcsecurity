...
<body class="d-flex flex-column h-100">
			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a id="changePasswordLink_#_${utenteItem.id }" class="btn btn-outline-primary btn-sm link-for-modal " data-bs-toggle="modal" data-bs-target="#confirmOperationModal2" >Resetta Password</a>
										</td>
									</tr>
								</c:forEach>
			                </tbody>
	    ...
	    <div class="modal-dialog" >
	        <div class="modal-content">
	            ...
	            <form method ="post" action="${pageContext.request.contextPath}/utente/cambiaPassword">
		            <div class="modal-footer">
		            	<input type="hidden" name="idUtenteResetPassword" id="idUtenteResetPassword">
		                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Chiudi</button>
		                <input type="submit" value="Continua"  class="btn btn-primary">
		            </div>
	            </form>
	...
	<script type="text/javascript">
		...
		$(".link-for-modal").click(function(){
			...
			var callerId2 = $(this).attr('id').substring(21);
			$('#idUtenteResetPassword').val(callerId2);
		});
